...
const progressStorageKey = 'progress_a1_eng_review_3_v1';
const mainProgressKey = 'progress_a1_eng_review_3';

export default function Repaso3Page() {
            ...
            <main className="flex-1 p-4 md:p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl font-bold dark:text-primary">Repaso 3</h1>
                    </div>
