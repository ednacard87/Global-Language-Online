...
import { getA2EngUnitPath, PathItem } from "@/lib/course-data";
...
export default function A2EngUnitPage() {
    ...
    <div className="flex w-full flex-col ingles-dashboard-bg min-h-screen">
      ...
      <main className="flex flex-1 flex-col items-center gap-8 p-4 md:py-12">
        <div className="text-center">
            ...
            <Link href="/ingles/a2" className="text-sm text-muted-foreground hover:underline mt-2 inline-block">
                &larr; {isClient ? t('dashboard.courseA2') : ''}
            </Link>
        </div>
