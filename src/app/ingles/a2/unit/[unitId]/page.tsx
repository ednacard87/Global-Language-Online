    ...
    <div className="flex w-full flex-col ingles-dashboard-bg min-h-screen">
      ...
      <main className="flex flex-1 flex-col items-center gap-8 p-4 md:py-12">
        <div className="text-center">
            <h1 className="text-4xl font-bold text-brand-purple dark:text-primary [text-shadow:1px_1px_2px_rgba(0,0,0,0.5)]">{isClient ? t('a2course.unitTitle', { unit: unitId }) : ''}</h1>
            <Link href="/ingles/a2" className="text-sm font-bold text-primary hover:underline mt-2 inline-block">
