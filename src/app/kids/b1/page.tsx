...
import { getKidsB1MainPath, PathItem } from "@/lib/course-data";
...
export default function KidsB1CoursePage() {
  ...
  useEffect(() => {
    ...
    const updatePath = () => {
        const initialPath = getKidsB1MainPath(t);
                ...
                >
                    <CardContent className="p-8 pt-4 border-t">
                        <CardHeader className="p-0">
                            <CardTitle>{isClient ? t('kidsPage.overallProgress') : 'Overall Progress'}</CardTitle>
                            <CardDescription>{isClient ? 'Tu progreso total en el curso B1 para niños.' : 'Your total progress in the B1 kids course.'}</CardDescription>
                        </CardHeader>
                        <div className="pt-4">
