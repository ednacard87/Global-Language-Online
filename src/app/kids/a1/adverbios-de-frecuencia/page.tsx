...
export default function AdverbiosDeFrecuenciaPage() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
              <div className="mb-8">
                <Link href={`/kids/a1`} className="hover:underline text-sm text-muted-foreground">
                    Volver al curso A1 de Niños
                </Link>
                <h1 className="text-4xl font-bold dark:text-primary">Adverbios de Frecuencia</h1>
              </div>
              <Card>
