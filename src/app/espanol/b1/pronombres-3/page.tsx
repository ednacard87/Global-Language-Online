...
const progressStorageVersion = 'progress_es_b1_pron_3_v1_skeleton';
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase: Pronombres 3.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
