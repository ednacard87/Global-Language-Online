...
const progressStorageVersion = 'progress_es_b1_por_para_v1_base';
...
function PorParaContent() {
    ...
    // Definición de la ruta de aprendizaje de 10 pasos
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 text-left text-white">
                        ...
                        <h1 className="text-4xl font-black [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-tight flex items-center gap-3">
                            <Zap className='h-10 w-10 text-primary' /> Por vs Para 🇪🇸 (B1)
                        </h1>
                    </div>
