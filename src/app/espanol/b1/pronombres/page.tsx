...
const progressStorageVersion = 'progress_es_b1_pronombres_v1_base';
const mainProgressKey = 'progress_b1_es_pronombres';
...
export default function PronombresB1Page() {
    return (
        <Suspense fallback={
