...
const progressStorageVersion = 'progress_es_b1_doble_pro_v1_base';
...
function DoblePronombreContent() {
            ...
            <Card className="shadow-soft border-2 border-brand-purple bg-card/95 backdrop-blur-sm text-foreground text-left overflow-hidden">
                ...
                <CardContent className="py-12 flex flex-col items-center justify-center min-h-[400px] text-center space-y-6">
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='text-muted-foreground text-xl'>El contenido interactivo para "{topic.name}" se está cargando en la base de misiones de nivel avanzado.</p>
                    </div>
                </CardContent>
...
export default function DoblePronombreB1Page() {
    return (
        <Suspense fallback={
