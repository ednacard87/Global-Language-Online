...
const progressStorageVersion = 'progress_es_b1_futuro_v1_base';
...
function FuturoContent() {
    ...
    // Definición de la ruta de aprendizaje de 12 pasos
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Completa esta sección para avanzar en tu misión de futuro.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="py-12 flex flex-col items-center justify-center min-h-[400px] text-center space-y-6 text-foreground">
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='text-muted-foreground text-xl'>El contenido interactivo para "{topic.name}" se está cargando en la base de datos de nivel B1.</p>
                    </div>
                </CardContent>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 text-left text-white">
                        ...
                        <h1 className="text-4xl font-black [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-tight flex items-center gap-3">
                            <Zap className='h-10 w-10 text-primary' /> El Futuro en Español 🇪🇸
                        </h1>
                    </div>
