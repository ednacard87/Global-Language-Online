...
const choiceExercisesData = [
    ...
    { text: "ellos _______ (crear) soluciones sostenibles", options: ["crearain", "crearán", "crean"], answer: "crearán" },
    { text: "en el futuro, yo _______ (vivir) en un mundo mejor", options: ["vivirés", "vivirá", "viviré"], answer: "viviré" },
    { text: "en el futuro, nosotros _______ (vivir) en casas inteligentes", options: ["vivirán", "viviremos", "vivimos"], answer: "viviremos" },
