...
const progressStorageVersion = 'progress_es_b1_pron_2_v1_skeleton';
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase: Pronombres 2.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
