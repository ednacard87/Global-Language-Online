...
const progressStorageVersion = 'progress_es_a2_imp_af_v1_skeleton';
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase: Imperativo Afirmativo.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 text-left text-white">
                        ...
                        <h1 className="text-4xl font-black [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-tight flex items-center gap-3">
                           <Activity className='h-10 w-10 text-primary' /> Imperativo Afirmativo 🇪🇸
                        </h1>
                    </div>
