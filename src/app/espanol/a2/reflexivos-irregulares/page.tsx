...
const progressStorageKey = 'progress_espanol_a2_reflex_irreg_v1';
const mainProgressKey = 'progress_a2_es_4';
...
export default function ReflexivosIrregularesPage() {
    ...
    const initialLearningPath = useMemo((): Topic[] => [
        { key: 'vocabulario', name: 'Vocabulario (Reflex. Irreg)', icon: BookOpen, status: 'active' },
            ...
            <main className="flex-1 p-4 md:p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl font-bold dark:text-primary">Reflexivos Irregulares</h1>
                    </div>
