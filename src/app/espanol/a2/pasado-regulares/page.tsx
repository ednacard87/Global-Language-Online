...
const progressStorageVersion = 'progress_es_a2_pasado_reg_v1_base';
    ...
    const renderContent = () => {
        ...
        return (
            <Card className="shadow-soft border-2 border-brand-purple bg-card/95 backdrop-blur-sm text-foreground text-left">
                <CardHeader>
                    <CardTitle className="text-primary uppercase flex items-center gap-2">
                ...
                <CardContent className="min-h-[300px] flex flex-col items-center justify-center space-y-4">
                    <div className="p-8 bg-muted/50 rounded-full">
                        {topic?.icon && <topic.icon className="h-16 w-16 text-primary/30" />}
                    </div>
                    <h3 className="text-xl font-bold uppercase tracking-widest text-muted-foreground">PROXIMAMENTE: {topic?.name}</h3>
                    <p className="text-muted-foreground text-center max-w-md">Estamos preparando el contenido de esta misión. Estará disponible muy pronto.</p>
                </CardContent>
                <CardFooter className="justify-center border-t pt-6">
                    <Button onClick={() => handleTopicComplete(selectedTopic)} size="lg" className="px-16 font-bold">Completar Misión</Button>
                </CardFooter>
            </Card>
        );
    };
