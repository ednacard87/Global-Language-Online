...
const progressStorageVersion = 'progress_es_a2_ps_vs_imp_v1_base';
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 text-left text-white">
                        ...
                        <h1 className="text-4xl font-black [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-tight flex items-center gap-3">
                            <Zap className='h-10 w-10 text-primary' /> Pasado Simple vs Imperfecto 🇪🇸
                        </h1>
                    </div>
