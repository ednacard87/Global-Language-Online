...
const progressStorageKey = 'progress_espanol_a2_verbos_reg_v1';
const mainProgressKey = 'progress_a2_es_1';

export default function VerbosRegularesPage() {
    ...
    const initialLearningPath = useMemo((): Topic[] => [
        { key: 'vocabulario', name: 'Vocabulario (Regulares)', icon: BookOpen, status: 'active' },
