...
const progressStorageVersion = 'progress_es_a2_obligacion_v1_skeleton';
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase: Obligación.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
