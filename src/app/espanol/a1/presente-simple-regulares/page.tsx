...
const progressStorageVersion = 'progress_es_a1_pres_reg_v1_base';
...
function PresenteSimpleRegularesContent() {
    ...
    useEffect(() => {
        ...
        // Reparación de ruta: asegurar secuencia lógica de desbloqueo
        let lastDone = true;
        ...
        // Pequeño delay de cortesía para el spinner
...
export default function PresenteSimpleRegularesPage() {
    return (
        <Suspense fallback={
            ...
            <PresenteSimpleRegularesContent />
        </Suspense>
    );
}