...
const progressStorageVersion = 'progress_es_a1_pres_irreg_v1_base';
...
function PresenteSimpleIrregularesContent() {
    ...
    // ASYNC FLOW 2: Guardado automático de progreso (Solo para estudiantes)
    useEffect(() => {
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 text-left text-white">
                        ...
                        <h1 className="text-4xl font-black [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-tight flex items-center gap-3">
                            <Activity className='h-10 w-10 text-primary' /> Presente Simple Irregulares 🇪🇸
                        </h1>
                    </div>
...
export default function PresenteSimpleIrregularesPage() {
    return (
        <Suspense fallback={
            ...
            <PresenteSimpleIrregularesContent />
        </Suspense>
    );
}