...
const negativePrompts = [
    ...
    { en: "You don't have my cellphone.", es: ["tu no tienes mi celular", "usted no tiene mi celular"] },
    { en: "My sister doesn't have a cat.", es: ["mi hermana no tiene un gato"] },
    { en: "Your uncle doesn't have a house.", es: ["tu tío no tiene una casa", "tu tio no tiene una casa"] },
    ...
    { en: "We don't have their address.", es: ["nosotros no tenemos su dirección", "nosotros no tenemos su direccion"] },
    { en: "I don't have your backpack.", es: ["yo no tengo tu mochila", "yo no tengo tu maleta"] },
