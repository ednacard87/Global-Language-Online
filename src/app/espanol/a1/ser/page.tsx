...
const progressStorageVersion = 'progress_es_a1_ser_v1_base';
    ...
    const renderContent = () => {
        ...
        return (
            <Card className="shadow-soft border-2 border-brand-purple bg-card/95 backdrop-blur-sm text-foreground text-left overflow-hidden">
                ...
                <CardContent className="py-12 flex flex-col items-center justify-center min-h-[350px] text-center space-y-6 text-foreground">
