...
export default function EspanolA1UnitPage() {
    ...
    <div className="flex w-full flex-col espanol-dashboard-bg min-h-screen">
      ...
      <main className="flex flex-1 flex-col items-center gap-8 p-4 md:py-12">
        <div className="text-center">
            ...
            <Link href="/espanol/a1" className="text-sm font-bold text-white/80 hover:underline mt-2 inline-block">
                &larr; Volver a Ruta A1
            </Link>
        </div>
        <div className="w-full max-w-4xl">
            <MazeGame 
                ...
                description="Completa los desafíos para dominar los fundamentos."
