...
export const espanolIntroPathData: PathItem[] = [
    ...
    { type: 'practice', icon: Puzzle, label: 'kidsPage.finalTest', href: '/quiz-payment/final', storageKey: 'progress_es_quiz_final' },
    { type: 'end', icon: Flag, label: 'dashboard.finish' }
];
...
export const getA2EspanolPath = (t: (key: string) => string): PathItem[] => [
    ...
    { type: 'class', icon: BookOpen, label: 'a2Espanol.reflexivosRegulares', href: '#', storageKey: 'progress_a2_es_3' },
    { type: 'class', icon: BookOpen, label: 'a2Espanol.reflexivosIrregulares', href: '#', storageKey: 'progress_a2_es_4' },
    { type: 'class', icon: BookOpen, label: 'a2Espanol.reflexivosMix', href: '#', storageKey: 'progress_a2_es_5' },
