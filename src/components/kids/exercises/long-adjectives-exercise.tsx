...
const exercisePrompts = [
    { spanish: "EL TE ES MAS CARO QUE EL AGUA", english: ["tea is more expensive than water"] },
    { spanish: "IRAK ES EL PAIS MAS PELIGROSO DEL MUNDO", english: ["iraq is the most dangerous country in the world"] },
    { spanish: "ESTE ES EL ARTICULO MAS IMPORTANTE DE LA REVISTA", english: ["this is the most important article in the magazine"] },
    { spanish: "EL ES MAS ELEGANTE QUE ELLA", english: ["he is more elegant than her"] },
    { spanish: "IPHONE ES EL CELULAR MAS COSTOSO", english: ["iphone is the most expensive cellphone"] },
    { spanish: "UN TIGRE ES MAS PELIGROSO QUE UN GATO", english: ["a tiger is more dangerous than a cat"] },
    { spanish: "JAMES ES MAS FAMOSO QUE EL TINO", english: ["james is more famous than el tino"] },
    { spanish: "EL ESPAÑOL ES MAS DIFICIL QUE EL INGLÉS", english: ["spanish is more difficult than english"] },
    { spanish: "PETER ES EL HOMBRE MAS ELEGANTE EN LA FIESTA", english: ["peter is the most elegant man at the party"] },
    { spanish: "DANI ES MAS INTELIGENTE QUE SU PRIMO", english: ["dani is more intelligent than his cousin"] },
    { spanish: "ESE VESTIDO ES EL MAS ELEGANTE DEL EVENTO, ELLA LUCE HERMOSA", english: ["that dress is the most elegant of the event, she looks beautiful"] },
    { spanish: "MEDELLIN ERA LA CIUDAD MAS PELIGROSA DE LATINOAMERICA EN 1990 HOY EN DIA MEDELLIN ES LA CIUDAD MAS MODERNA DE COLOMBIA, MUCHOS TURISTAS LLEGAN TODOS LOS DIAS PARA CONOCER SUS LUGARES TURISTICOS", english: ["medellin was the most dangerous city in latin america in 1990 today medellin is the most modern city in colombia many tourists arrive every day to see its tourist places"] },
    { spanish: "ESA CASA ES MAS CARA QUE ESTA", english: ["that house is more expensive than this one"] }
];

type ValidationStatus = 'correct' | 'incorrect' | 'unchecked';

export function LongAdjectivesExercise({ onComplete }: { onComplete: () => void }) {
        ...
        return (
            <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
                <CardContent className="p-6 text-center flex flex-col items-center justify-center min-h-[300px]">
                    ...
                    <p className="text-muted-foreground mt-2">Has dominado los ejercicios de adjetivos largos.</p>
                </CardContent>
            </Card>
        );
    }
    ...
    return (
        <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
            <CardHeader>
                <CardTitle>Ejercicio Adjetivos Largos</CardTitle>
