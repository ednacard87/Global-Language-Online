...
const exercisePrompts = [
    { spanish: "MI CASA ES MAS GRANDE QUE LA TUYA", english: ["my house is bigger than yours"] },
    { spanish: "ESTE ESCRITORIO ES MAS PEQUEÑO QUE EL OTRO", english: ["this desk is smaller than the other one"] },
    { spanish: "MI PERRO ES MAS RAPIDO QUE EL PERRO DE JIMMY", english: ["my dog is faster than jimmy's dog"] },
    { spanish: "JIMMY ES MAS ALTO QUE JACK", english: ["jimmy is taller than jack"] },
    { spanish: "SU CASA ES MAS LIMPIA QUE LA DE ELLA (DE EL)", english: ["his house is cleaner than hers"] },
    { spanish: "ESTA CALLE ES MAS ANCHA QUE LA AVENIDA", english: ["this street is wider than the avenue"] },
];

type ValidationStatus = 'correct' | 'incorrect' | 'unchecked';

export function ComparativeExercise({ onComplete }: { onComplete: () => void }) {
        ...
        return (
            <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
                <CardContent className="p-6 text-center flex flex-col items-center justify-center min-h-[300px]">
                    ...
                    <p className="text-muted-foreground mt-2">Has dominado los ejercicios de comparativos.</p>
                </CardContent>
            </Card>
        );
    }
    ...
    return (
        <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
            <CardHeader>
                <CardTitle>Ejercicio Comparativo</CardTitle>
                 <CardDescription>Traduce las frases usando adjetivos comparativos.</CardDescription>
