...
const exercisePrompts = [
    { spanish: "EL PERRO DE MIKE", english: ["mike's dog"] },
    { spanish: "LAS BICICLETAS DE LOS NIÑOS", english: ["the children's bicycles"] },
    { spanish: "EL GATO DE MI TIA ES NEGRO", english: ["my aunt's cat is black"] },
    { spanish: "EL LIBRO DE THOMAS ESTA NUEVO", english: ["thomas's book is new", "thomas' book is new"] },
    { spanish: "LOS HIJOS DE MIS HERMANOS SON GEMELOS", english: ["my brothers' sons are twins"] },
    { spanish: "EL COMPUTADOR DE SU HERMANO ESTA VIEJO (DE ELLA)", english: ["her brother's computer is old"] },
    { spanish: "LA COMIDA DE SUS PAJAROS (DE ELLOS)", english: ["their birds' food"] },
    { spanish: "LAS LLAVES DE SUS PADRES (DE ÉL)", english: ["his parents' keys"] },
    { spanish: "LA CASA DE JANET ES GRANDE", english: ["janet's house is big"] },
    { spanish: "LOS CARROS DE MIS PRIMOS SON BLANCOS", english: ["my cousins' cars are white"] },
    { spanish: "LA CARNE DE TU GATO ESTA EN LA NEVERA", english: ["your cat's meat is in the fridge"] },
    { spanish: "LOS ZAPATOS DE MI HERMANA SON MUY FEOS", english: ["my sister's shoes are very ugly"] },
    { spanish: "LA SOMBRILLA DE MI MADRE", english: ["my mother's umbrella"] }
];

type ValidationStatus = 'correct' | 'incorrect' | 'unchecked';

export function GenitiveSaxonGsExercise({ onComplete, vocabulary }: { onComplete: () => void, vocabulary?: Record<string, string> }) {
        ...
        return (
            <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
                <CardContent className="p-6 text-center flex flex-col items-center justify-center min-h-[300px]">
                    ...
                    <p className="text-muted-foreground mt-2">Has dominado los ejercicios de Genitivo Sajón.</p>
                </CardContent>
            </Card>
        );
    }
        ...
        <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
            <CardHeader>
                <div className="flex justify-between items-start">
                    <div>
                        <CardTitle>Ejercicio G.S</CardTitle>
