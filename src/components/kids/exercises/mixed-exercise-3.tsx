...
const exercisePrompts = [
    { spanish: "SHAKIRA ES LA CANTANTE MAS FAMOSA DE COLOMBIA", english: ["shakira is the most famous singer in colombia"] },
    { spanish: "LOS BEATLES HAN SIDO EL MEJOR GRUPO MUSICAL DE INGLATERRA", english: ["the beatles have been the best musical group in england"] },
    { spanish: "ESTE ES EL CARRO MAS AMARILLO (DE TODOS)", english: ["this is the yellowest car of all"] },
    { spanish: "ESE GATO ES MAS VIEJO QUE ESTE PERRO", english: ["that cat is older than this dog"] },
    { spanish: "SHAKIRA ES MAS FAMOSA QUE JUANES", english: ["shakira is more famous than juanes"] },
    { spanish: "ALASKA ES MAS FRIA QUE COLOMBIA", english: ["alaska is colder than colombia"] },
    { spanish: "ALASKA ES EL ESTADO MAS FRIO DE LOS ESTADOS UNIDOS", english: ["alaska is the coldest state in the united states"] },
    { spanish: "EMMA ES MAS GORDITA QUE SAMANTHA", english: ["emma is fatter than samantha"] },
    { spanish: "ELLOS SON MAS AMABLES QUE MIS PARIENTES", english: ["they are kinder than my relatives"] },
    { spanish: "TU ERES MAS FLACO QUE LUCAS", english: ["you are thinner than lucas"] }
];

type ValidationStatus = 'correct' | 'incorrect' | 'unchecked';

export function MixedExercise3({ onComplete }: { onComplete: () => void }) {
        ...
        return (
            <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
                <CardContent className="p-6 text-center flex flex-col items-center justify-center min-h-[300px]">
                    ...
                    <p className="text-muted-foreground mt-2">Has dominado los ejercicios mixtos 3.</p>
                </CardContent>
            </Card>
        );
    }
    ...
    return (
        <Card className="shadow-soft rounded-lg border-2 border-brand-purple">
            <CardHeader>
                <CardTitle>Ejercicio Mixtos 3</CardTitle>
