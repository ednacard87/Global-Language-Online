...
export default function Class20Content() {
    ...
    if (isInitialLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px]">
                ...
                <p className="text-white font-bold tracking-widest animate-pulse uppercase">Sincronizando Misión B2...</p>
            </div>
        );
    }
                ...
                <Card className="shadow-soft rounded-lg border-2 border-brand-purple bg-card/90 backdrop-blur-sm overflow-hidden py-10">
                    <CardHeader className="text-center pt-10">
                        ...
                        <CardTitle className="text-4xl font-black uppercase tracking-tighter text-primary">
                            ¡Clase 20 (B2) en desarrollo!
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="text-center space-y-8 pb-10">
                        <p className="text-xl text-muted-foreground leading-relaxed px-6 text-black">
                            Estamos preparando el contenido final de este nivel para completar tu gran aventura B2.
                            <br />
                        ...
                        <div className="flex justify-center">
                            <Button asChild variant="default" size="lg" className="rounded-full px-10 font-bold h-14 shadow-lg bg-primary hover:bg-primary/90 text-primary-foreground transition-all active:scale-95">
                                <Link href="/ingles/b2">
                                    <ArrowLeft className="mr-2 h-5 w-5" /> Volver al curso B2
                                </Link>
                            </Button>
                        </div>
                    </CardContent>
                    <CardFooter className="justify-center border-t pt-4 bg-muted/20">
                        <p className="text-xs text-muted-foreground uppercase font-bold tracking-widest">Global English Online - Contenedor B2 Blindado</p>
                    </CardFooter>
                </Card>
            </div>
                    ...
                    <CardContent>
                        <nav>
                            <ul className="space-y-1">
                                <li className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg text-muted-foreground/50 cursor-not-allowed text-black">
                                    <Lock className="h-5 w-5 text-yellow-500" />
                                    <span>Contenido bloqueado</span>
                                </li>
                                <li className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg text-muted-foreground/50 cursor-not-allowed text-black">
                                    <Lock className="h-5 w-5 text-yellow-500" />
                                    <span>Práctica final bloqueada</span>
                                </li>
                            </ul>
                        </nav>
