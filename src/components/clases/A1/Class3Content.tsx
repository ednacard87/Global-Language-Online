...
export default function Class3Content() {
    ...
    const handleTopicSelect = (key: string) => {
        ...
        if (['grammar2', 'can'].includes(key)) handleTopicComplete(key);
    };
                ...
                return (
                    <div className="space-y-6 text-left">
                        <Card className="shadow-soft rounded-lg border-2 border-brand-purple bg-card/95 backdrop-blur-sm text-foreground">
                            ...
                            <CardFooter className="justify-center border-t pt-6"><Button onClick={() => handleTopicComplete('grammar2')} size="lg" className="px-12 font-bold text-white">Entendido <ArrowRight className="ml-2" /></Button></CardFooter>
                        </Card>
                    </div>
                );
                ...
                return (
                    <div className="space-y-6 text-left text-black">
                        <Card className="shadow-soft rounded-lg border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                            ...
                            <CardFooter className="justify-center border-t pt-6"><Button onClick={() => handleTopicComplete('presentSimpleUses')} size="lg" className="px-12 font-bold text-white">Continuar</Button></CardFooter>
                        </Card>
                    </div>
                );
                    ...
                    <Card className="shadow-soft rounded-lg border-2 border-brand-purple bg-card/95 backdrop-blur-sm p-6 text-left">
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                <div className="font-bold bg-muted p-2 rounded text-black">Español</div><div className="font-bold bg-muted p-2 rounded text-black">Inglés</div>
                                {vocab2Data.map((v, i) => (
                                    <React.Fragment key={i}>
                                        <div className="p-2 border rounded bg-card flex items-center font-medium text-black">{v.es}</div>
                        ...
                        <CardFooter className="justify-between mt-4"><Button onClick={handleVocab2Check}>Verificar</Button><Button onClick={() => handleTopicComplete('vocabulary2')} disabled={!canAdvanceVocab2 && !isAdmin} className='text-white'>Avanzar</Button></CardFooter>
                    </Card>
                );
                ...
                return (
                    <div className="space-y-6 text-left text-black dark:text-white">
                        <Card className="shadow-soft rounded-lg border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                            ...
                            <CardContent className="space-y-6">
                                <div className="p-6 bg-slate-100 dark:bg-slate-800/50 rounded-[2rem] border border-border/50 text-black">
                            ...
                            <CardFooter className="justify-center border-t pt-6"><Button onClick={() => handleTopicComplete('can')} size="lg" className="px-16 font-bold h-14 text-xl text-white">Entendido <ArrowRight className="ml-2 h-6 w-6" /></Button></CardFooter>
                        </Card>
                    </div>
                );
