...
export default function EngA1Class7Page() {
    ...
    const renderContent = () => {
        ...
        switch (selectedTopic) {
            ...
            case 'ex4': return <SimpleTranslationExercise exerciseKey="c7_ex4" course="a1" onComplete={() => handleTopicComplete('ex4')} title="Exercise 4" vocabulary={{"primos" : "cousins" , "mientras" : "while" , "noche" : "night","preferir": "prefer", "calor": "heat", "frio": "cold", "terror": "horror", "ajo": "garlic", "futbol" : "soccer" , "verduras" : "vegetables" , "metal": "metal", "novelas": "soap operas", "fresas": "strawberries", "Caminar" : "to walk" , "Barrio" : "neighborhood" , "Peligroso" : "dangerous" , "pintar": "paint", "mentiras": "lies", "carpintería": "carpentry", "espinaca": "spinach", "remolacha": "beet", "Apartamento" : "apartment" , "Romantica" : "romantic" , "Rompecabezas" : "puzzle" , "Redes sociales" : "social Media" , "pueblo": "town", "ciudad": "city" , "Carne" : "meat"}} highlightVocabulary={true} />;
