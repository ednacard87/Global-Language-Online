...
const progressStorageVersion = 'progress_a2_eng_u4_c18_v1_secure';
const mainProgressKey = 'progress_a2_eng_unit_4_class_18';
...
export default function Class18Content({ overrideStudentId }: { overrideStudentId?: string | null }) {
    ...
    // Definición de la ruta de aprendizaje solicitada (13 títulos)
    const initialPathData = useMemo((): Topic[] => [
        ...
        { key: 'grammar_agreement', name: '2. Grammar (Expressing Agreement)', icon: GraduationCap, status: 'locked' },
        { key: 'ex_tobe', name: '3. Exercise with To be', icon: PenSquare, status: 'locked' },
        { key: 'ex_dodoes', name: '4. Exercise with Do/Does', icon: PenSquare, status: 'locked' },
        { key: 'ex_modal', name: '5. Exercise with Modal V.', icon: PenSquare, status: 'locked' },
        { key: 'ex_mix_1', name: '6. Exercise Mix 1', icon: PenSquare, status: 'locked' },
        { key: 'exercise_1', name: '7. Exercise 1', icon: PenSquare, status: 'locked' },
        { key: 'choose_answer', name: '8. Choose the Answer', icon: CheckCircle2, status: 'locked' },
        { key: 'vocab_game', name: '9. Vocabulary (Game)', icon: Gamepad2, status: 'locked' },
        { key: 'complete_verbs', name: '10. Complete Verbs', icon: Pencil, status: 'locked' },
        { key: 'exercise_2', name: '11. Exercise 2', icon: PenSquare, status: 'locked' },
        { key: 'fill_gaps', name: '12. Fill the gaps 1', icon: Pencil, status: 'locked' },
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase 18 (A2).</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <Card className="shadow-soft rounded-lg sticky top-24 border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                    <CardHeader className="pb-4 border-b bg-muted/30">
                        <CardTitle className="text-lg font-black text-primary uppercase flex items-center gap-2">
                            <Trophy className="h-5 w-5 text-primary" /> Misión 18A
                        </CardTitle>
                    </CardHeader>
