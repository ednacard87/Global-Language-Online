...
const progressStorageVersion = 'progress_a2_eng_u2_c11_v1_base';
const mainProgressKey = 'progress_a2_eng_unit_2_class_11';
...
export default function Class11Content({ overrideStudentId }: { overrideStudentId?: string | null }) {
    ...
    const initialPathData = useMemo((): Topic[] => [
        { key: 'vocabulary_moods', name: '1. Vocabulary (Moods)', icon: Smile, status: 'active' },
        { key: 'grammar_present_perfect', name: '2. Grammar (Present Perfect)', icon: GraduationCap, status: 'locked' },
        { key: 'exercise_1', name: '3. Exercise 1', icon: PenSquare, status: 'locked' },
        { key: 'complete_verbs', name: '4. Complete Verbs', icon: Pencil, status: 'locked' },
        ...
        { key: 'grammar_both', name: '8. Grammar (Both)', icon: GraduationCap, status: 'locked' },
        { key: 'ex_both', name: '9. Exercise with Both', icon: PenSquare, status: 'locked' },
        { key: 'grammar_either', name: '10. Grammar (Either)', icon: GraduationCap, status: 'locked' },
        { key: 'ex_either', name: '11. Exercise with Either', icon: PenSquare, status: 'locked' },
        { key: 'grammar_neither', name: '12. Grammar (Neither)', icon: GraduationCap, status: 'locked' },
        { key: 'ex_neither', name: '13. Exercise with Neither', icon: PenSquare, status: 'locked' },
        { key: 'grammar_combined', name: '14. Grammar (Both-Either-Neither)', icon: GraduationCap, status: 'locked' },
        { key: 'ex_mix_1', name: '15. Exercise Mix', icon: PenSquare, status: 'locked' },
        { key: 'ex_mix_2', name: '16. Exercise Mix 2', icon: PenSquare, status: 'locked' },
        { key: 'reading', name: '17. Reading', icon: BookText, status: 'locked' },
        { key: 'fill_gaps', name: '18. Fill the Gaps', icon: Pencil, status: 'locked' },
    ], []);
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase 11.</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <Card className="shadow-soft rounded-lg sticky top-24 border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                    <CardHeader className="pb-4 border-b bg-muted/30">
                        <CardTitle className="text-lg font-black text-primary uppercase flex items-center gap-2">
                            <Trophy className="h-5 w-5 text-primary" /> Misión 11A
                        </CardTitle>
                    </CardHeader>
