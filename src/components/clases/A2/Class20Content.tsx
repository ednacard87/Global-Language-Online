...
const progressStorageVersion = 'progress_a2_eng_u4_c20_v1_secure_skeleton';
const mainProgressKey = 'progress_a2_eng_unit_4_class_20';
...
export default function Class20Content({ overrideStudentId }: { overrideStudentId?: string | null }) {
    ...
    const initialPathData = useMemo((): Topic[] => [
        { key: 'vocabulary_veg', name: '1. Vocabulary (Vegetables)', icon: Leaf, status: 'active' },
        { key: 'grammar_tag', name: '2. Grammar (Tag Questions)', icon: GraduationCap, status: 'locked' },
        { key: 'exercise_tag', name: '3. Exercise with Tag Q.', icon: PenSquare, status: 'locked' },
        { key: 'grammar_supposed', name: '4. Grammar 2 (To be Supposed to)', icon: GraduationCap, status: 'locked' },
        { key: 'exercise_supposed', name: '5. Exercise with To be S.', icon: PenSquare, status: 'locked' },
        { key: 'exercise_1', name: '6. Exercise 1', icon: PenSquare, status: 'locked' },
        { key: 'grammar_3', name: '7. Grammar 3', icon: GraduationCap, status: 'locked' },
        ...
        { key: 'complete_tag', name: '10. Complete the Tag Q.', icon: Pencil, status: 'locked' },
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase 20 (A2).</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <Card className="shadow-soft rounded-lg sticky top-24 border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                    <CardHeader className="pb-4 border-b bg-muted/30">
                        <CardTitle className="text-lg font-black text-primary uppercase flex items-center gap-2">
                            <Trophy className="h-5 w-5 text-primary" /> Misión 20A
                        </CardTitle>
                    </CardHeader>
