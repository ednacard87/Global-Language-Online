...
const progressStorageVersion = 'progress_a2_eng_u2_c9_v1_base';
...
export default function Class9Content({ overrideStudentId }: { overrideStudentId?: string | null }) {
    ...
    const initialPathData = useMemo((): Topic[] => [
        ...
        { key: 'grammar_regular', name: '2. Grammar (Regular Verbs)', icon: GraduationCap, status: 'locked' },
        { key: 'grammar_past_ed', name: '3. Past Simple = ED', icon: Clock, status: 'locked' },
        ...
        { key: 'final_exercise', name: '12. Final Exercise', icon: Trophy, status: 'locked' },
    ], []);
