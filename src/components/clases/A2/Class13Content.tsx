...
const progressStorageVersion = 'progress_a2_eng_u2_c13_v1_base';
const mainProgressKey = 'progress_a2_eng_unit_2_class_13';
...
export default function Class13Content({ overrideStudentId }: { overrideStudentId?: string | null }) {
    ...
    const initialPathData = useMemo((): Topic[] => [
        { key: 'vocabulary_shapes', name: '1. Vocabulary (Shapes and Textures)', icon: Shapes, status: 'active' },
        { key: 'dictation_1', name: '2. Dictation 1', icon: Mic, status: 'locked' },
        { key: 'questions_dict1', name: '3. Questions Dict1', icon: HelpCircle, status: 'locked' },
        ...
        { key: 'dictation_2', name: '6. Dictation 2', icon: Mic, status: 'locked' },
        { key: 'questions_dict2', name: '7. Questions Dict2', icon: HelpCircle, status: 'locked' },
                ...
                <CardHeader className='bg-primary/5 border-b'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <CardDescription className='font-bold text-foreground'>Sección de aprendizaje para la Clase 13 (Nivel A2).</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <Card className="shadow-soft rounded-lg sticky top-24 border-2 border-brand-purple bg-card/95 backdrop-blur-sm">
                    <CardHeader className="pb-4 border-b bg-muted/30">
                        <CardTitle className="text-lg font-black text-primary uppercase flex items-center gap-2">
                            <Trophy className="h-5 w-5 text-primary" /> Misión 13A
                        </CardTitle>
                    </CardHeader>
